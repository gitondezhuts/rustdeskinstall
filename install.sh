...
function setuphttp () {
    ...
    sed -i "s|secure-string|${string64rev}|g" WindowsAgentAIOInstall.ps1

    # Create linux install script
    wget https://raw.githubusercontent.com/dinger1986/rustdeskinstall/master/linuxclientinstall.sh
    sed -i "s|secure-string|${string64rev}|g" linuxclientinstall.sh
...
if [[ -z "$http" ]]; then
    ...
    echo -e "You can get an OpenSource API from here https://github.com/infiniteremote/installer"
